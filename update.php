  ...
  if(!empty($name)){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         $update_image = $conn->prepare("UPDATE `users` SET `img` = ? WHERE id = ?");
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         $message[] = 'كلمة المرور القديمة غير مطابقة!';
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
               ...
               <input type="password" name="cpass" placeholder="تأكيد كلمة المرور الجديدة" maxlength="50" class="box">
         </div>
      </div>
