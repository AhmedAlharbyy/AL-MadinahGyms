...
<section class="playlists">
   ...
   <h1 class="heading">adding Gyms</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">create new gyms</h3>
         <a href="add_gym.php" class="btn">add gym</a>
      </div>

      <?php
         $select_gym = $conn->prepare("SELECT * FROM `gym_dscr` WHERE states = ? ");
         $a='accepted';
         $select_gym->execute([$a]);
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_gym.php?get_id=<?= $gym_id; ?>" class="option-btn">تعديل معلومات النادي</a>
            <input type="submit" value="حذف" class="delete-btn" onclick="return confirm('delete this gym?');" name="delete">
         </form>
         <a href="view_gym.php?get_id=<?= $gym_id; ?>" class="btn">عرض معلومات النادي</a>
      </div>
      <?php
         } 
      }else{
